...
flag = 1
for line in  file('./data/Title.data'): # train
    line  = line.strip()
    line = line.split('\1')
    if flag==1:
        print line[0]
...
for line in  file('./data/Description.data'): # train
    line  = line.strip()
    line = line.split('\1')
    ...
    text_right = (' '.join(seg_list)).encode('utf-8','ignore').strip()
